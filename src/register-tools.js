...
// Shared by every entry point (stdio, Worker) so the server identifies itself
...
/** Registers every iCount tool on `server`. Shared by the stdio entry point and the Worker. */
